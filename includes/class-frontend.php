...
abstract class EU_Withdrawal_Button_Frontend extends EU_Withdrawal_Button_Emails {
    public function enqueue_styles(): void {
        ...
        if ($mode === 'none') { return; }
        $css = '.ewb-form-wrap{max-width:var(--ewb-form-max-width,760px);margin-inline:auto;text-align:center}.ewb-form{max-width:100%;margin-inline:auto;text-align:start}.ewb-form .ewb-field{margin-block:1rem}.ewb-form label{display:block;margin-bottom:.35rem}.ewb-form input[type=text],.ewb-form input[type=email],.ewb-form input[type=number],.ewb-form textarea,.ewb-form select{width:100%;max-width:100%;box-sizing:border-box}.ewb-form fieldset{margin:1rem 0}.ewb-form .ewb-item{display:grid;grid-template-columns:minmax(0,1fr) minmax(90px,130px);gap:1rem;align-items:center;margin:.65rem 0}.ewb-form-heading,.ewb-form-intro,.ewb-form-helper,.ewb-message{text-align:center}.ewb-message{margin:1rem 0}.ewb-confirmation-summary{max-width:var(--ewb-confirmation-max-width,640px);margin:1rem auto;text-align:start}.ewb-confirmation-details{display:grid;grid-template-columns:max-content minmax(0,1fr);gap:.35rem 1rem;margin:0 0 1rem}.ewb-confirmation-details dt{font-weight:600}.ewb-confirmation-details dd{margin:0}.ewb-confirmation-products,.ewb-confirmation-declaration{margin-top:1rem;padding-top:1rem;border-top:1px solid currentColor}.ewb-confirmation-products ul{margin:.5rem 0 0 1.25rem;padding:0}.ewb-confirmation-products li{margin:.25rem 0}.ewb-confirmation-declaration p{margin:.5rem 0 0}.ewb-actions{display:flex;gap:.75rem;flex-wrap:wrap;align-items:center;justify-content:center}.ewb-muted{opacity:.75}';
